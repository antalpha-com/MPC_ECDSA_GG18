...
func NewSignRound2Message(
	...
	// pfBob := pi1Ji.BytesFromProofBob()
	// pfBobWC := pi2Ji.BytesFromProofBobWC()
	pfBob := pi1Ji.Bytes()
	pfBobWC := pi2Ji.Bytes()
	// fmt.Printf("round2: to:%v,from:%v,pfBobWC: %v\n", to.Index, from.Index, pfBobWC)
...
func (m *SignRound2Message) UnmarshalProofBob() (*mta.ProofBob, error) {
	...
	// return mta.NewProofBobFromBytes(m.ProofBob)
...
func (m *SignRound2Message) UnmarshalProofBobWC(ec elliptic.Curve) (*mta.ProofBobWC, error) {
	...
	// return mta.NewProofBobWCFromBytes(ec, m.ProofBobWc)
}
