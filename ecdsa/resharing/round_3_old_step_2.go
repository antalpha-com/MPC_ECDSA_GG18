...
// Start function initializes and starts round 3 of the protocol
// round 3 of the protocol starts by checking if the round has already started
// and then proceeds with the necessary steps for parties in the old committee.
// It sends shares and messages to the parties in the new committee.
