...
func (round *round2) Start() *tss.Error {
	...
	modProof := &modproof.ProofMod{
		...
		B: zero,
		Z: *new([80]*big.Int)}
	// modProof := &modproof.Proofbuf{}
	// modProofCode := modproof.ProofToCode(modProof)
	...
	if !round.Parameters.NoProofMod() {
		...
		// modProof, err = modproof.NewProofMal(ContextI, preParams.PaillierSK.N, preParams.PaillierSK.P, preParams.PaillierSK.Q)
		// modproof = modproof.CodeToProof(modProofCode)
		if err != nil {
			return round.WrapError(err, Pi)
		}
	}
	// TODO:此处传入的modProof是空的
