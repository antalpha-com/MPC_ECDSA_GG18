...
func NewDGRound2Message1(
	...
	// modProof *modproof.ProofModCode,
	...
	// TODO:判断modProof是否为空
	if modProof.Z[0] != nil {
		modPfBzs = modProof.Bytes2()
	}
	// modPfBzs, err := modProof.BytesTest()
	// if err != nil {
	// 	fmt.Println("modProof.BytesTest() error:", err)
	// }
...
//	}
func (m *DGRound2Message1) UnmarshalModProof() (*modproof.ProofMod, error) {
	return modproof.NewProofFromBytes2(m.GetModProof())
}
...
func (m *DGRound4Message1) UnmarshalFacProof() (*facproof.ProofFac, error) {
	return facproof.NewProofFromBytes2(m.GetFacProof())
}
